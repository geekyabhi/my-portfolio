                                    ...
                                    <div className="personal-info padd-15">
                                        <div className="row">
                                            <div className="info-item padd-15">
                                                <p>Birthday : <span><Moment format="DD MMM YYYY">{about.birthday}</Moment></span></p>
                                            </div>
                                            <div className="info-item padd-15">
                                                <p>City : <span>{about.city}</span></p>
                                            </div>
                                            <div className="info-item padd-15">
                                                <p>Mail : <span>{about.gmail}</span></p>
                                            </div>
                                            <div className="info-item padd-15">
                                                <p>Hobbies : <span>{about.hobbies}</span></p>
                                            </div>
                                        </div>
                                        <div className="row">
                                            <div className="buttons padd-15">
                                                <a href={about.resume} target="_blank" rel="noopener noreferrer" className="btn">Download CV</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
